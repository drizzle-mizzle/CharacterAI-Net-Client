...
public class CharacterResponse
{
    ...
    public CharacterResponse(dynamic response)
    {
        ...
        {
            CharacterMessage = GetCharacterResponse(responseParsed.replies);
    ...
    private static dynamic ParseCharacterResponse(dynamic response)
    {
        ...
        try
        {
            ...
            if (abortChunk is not null)
            {
                ...
                if (lastMessageChunk is not null && GetCharacterResponse((JArray)lastMessageChunk.replies) is CharacterMessage lastReply)
    ...
    private static CharacterMessage? GetCharacterResponse(JArray? jReplies)
    {
